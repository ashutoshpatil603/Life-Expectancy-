...
df.drop(df[(df['Life expectancy '] > 30) & (df['Schooling'] < 1.5)].index, inplace=True,)
df.drop(df[(df['Life expectancy '] < 40) & (df[' BMI'] > 40)].index, inplace=True)
df.drop(df[(df['Life expectancy '] > 40) & (
    df['Income composition of resources'] < 0.1)].index, inplace=True)
